...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
      <div class="container">
        <a class="navbar-brand js-scroll-trigger" href="index.php">JOGJA WISATA</a></a>
	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url('img/mbuntu-1.jpg');">
			<div class="wrap-login100 p-b-30">
				...
				<form action="save_registrasi.php" method="post">
					...
					<div class="text-center w-full p-t-25">
						<p class="txt1 text-white">Sudah Punya Akun? </p><a href="signin.php" class="txt1 text-white">Log In Sekarang</a>
					</div>
