...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
      <div class="container">
        <a class="navbar-brand js-scroll-trigger" href="index.php">JOGJA WISATA</a>
			...
			<div class="wrap-login100 p-b-30">
				<form class="login100-form validate-form">
					...
					<div class="text-center w-full p-t-25">
						<p class="txt1 text-white">Belum Punya Akun? </p><a href="registrasi.php" class="txt1 text-white">Daftar Sekarang</a>
					</div>
				</form>
			</div>
		</div>
