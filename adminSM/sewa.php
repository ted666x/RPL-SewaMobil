						...
						<div class="panel panel-default">
							...
							<?php if($error){?><div class="errorWrap"><strong>ERROR</strong>:<?php echo htmlentities($error); ?> </div><?php } 
								...
								<table id="zctb" class="display table table-striped table-bordered table-hover" cellspacing="0" width="100%">
									...
									<?php
										$i=0;
										$sqlsewa = "SELECT booking.*,mobil.*,merek.*,usersm.* FROM booking,mobil,merek,usersm WHERE booking.id_mobil=mobil.id_mobil
													AND merek.id_merek=mobil.id_merek AND usersm.email=booking.email ORDER BY booking.kode_booking DESC";
